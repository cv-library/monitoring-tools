...
APP_NAME = os.environ.get("APP_NAME", "app-cvl")
EXPOSE_PORT = os.environ.get("EXPOSE_PORT", 8000)
OTLP_GRPC_ENDPOINT = os.environ.get("OTLP_GRPC_ENDPOINT", "http://opentelemetry-collector:4317")
#OTLP_GRPC_ENDPOINT = os.environ.get("OTLP_GRPC_ENDPOINT", "http://tempo:4317")

TARGET_ONE_HOST = os.environ.get("TARGET_ONE_HOST", "locations-cv-resume-library")
TARGET_TWO_HOST = os.environ.get("TARGET_TWO_HOST", "candidates-cv-resume-library")
...
async def chain(response: Response):
    ...
    headers['X-Scope-OrgID'] = 'cv-library'
